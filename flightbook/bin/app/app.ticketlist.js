...
var TicketList = (function () {
    ...
    TicketList.prototype.changeIndexToTwo = function () {
        this.index = 2;
        console.log("index changed to: " + this.index);
    };
    TicketList.prototype.changeIndexToThree = function () {
        this.index = 3;
        console.log("index changed to: " + this.index);
    };
    TicketList.prototype.changeIndexToFour = function () {
        this.index = 4;
        console.log("index changed to: " + this.index);
    };
    TicketList.prototype.changeIndexToFive = function () {
        this.index = 5;
        console.log("index changed to: " + this.index);
    };
    TicketList.prototype.changeIndexToSix = function () {
        this.index = 6;
        console.log("index changed to: " + this.index);
    };
    TicketList.prototype.changeIndexToSeven = function () {
        this.index = 7;
        console.log("index changed to: " + this.index);
    };
    TicketList.prototype.changeIndexToEight = function () {
        this.index = 8;
        console.log("index changed to: " + this.index);
    };
    ...
    TicketList.prototype.deleteTicket = function (index) {
        console.log(this.tickets);
